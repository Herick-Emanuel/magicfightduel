...
function PaginaLogin() {
  ...
  const validatePassword = (passwordToValidate) => passwordToValidate.length >= 6;
  ...
  const renderButtonContent = () => {
    ...
    return isRegistering ? 'Registrar' : 'Entrar';
  };
      ...
      <FormContainer>
        ...
        >
          ...
          <StyledTextField
            ...
            helperText={
              !!errorMessage && !validatePassword(password) ? errorMessage : ''
            }
            InputProps={{
              endAdornment: (
          ...
          {isRegistering && (
            <StyledTextField
              ...
              helperText={
                !!errorMessage && password !== confirmPassword ? errorMessage : ''
              }
            />
          )}
          {errorMessage && (
